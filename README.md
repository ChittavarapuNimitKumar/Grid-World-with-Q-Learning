# Grid World Game Solver with Q-Learning

## Aim
Showcase reinforcement learning fundamentals using a Q-learning agent in a toy grid world.

## Algorithm
- Q-table keeps track of state-action values.
- Agent learns through trial and error per episode to navigate towards the goal while avoiding obstacles.
- Q-values update using the formula:
...
```
## Output sample
Learned path to goal: [(0, 0), (0, 1), (0, 2), (0, 3)]
